...
void marker_manager::initialize(ros::NodeHandle& nh, id_label_map_ptr id_label_map)
{
    ...
    interactive_marker_server_ = std::unique_ptr<interactive_markers::InteractiveMarkerServer>(new interactive_markers::InteractiveMarkerServer("interactive", "", false));
}
