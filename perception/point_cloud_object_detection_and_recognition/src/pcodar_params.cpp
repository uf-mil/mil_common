...
// std::vector<Eigen::Vector2d> boundary = {Eigen::Vector2d(-10, -10),
// Eigen::Vector2d(-10, 10), Eigen::Vector2d(100, -100), Eigen::Vector2d(100,
// 100)};
std::vector<Eigen::Vector2d> boundary = {
    Eigen::Vector2d(-80, -175), Eigen::Vector2d(-100, -45),
    Eigen::Vector2d(100, 5), Eigen::Vector2d(100, -175)};
void set_params(ros::NodeHandle& nh) {
  ...
  nh.getParam("/pcodar/filter_points_leaf_size_x",
              params.filter_points_leaf_size_x);
  nh.getParam("/pcodar/filter_points_leaf_size_y",
              params.filter_points_leaf_size_y);
  nh.getParam("/pcodar/filter_points_leaf_size_z",
              params.filter_points_leaf_size_z);

  nh.getParam("/pcodar/remove_points_near_lidar_distance",
              params.remove_points_near_lidar_distance);

  nh.getParam("/pcodar/outier_removal_std_dev_thresh",
  ...
  nh.getParam("/pcodar/max_distance_for_association",
