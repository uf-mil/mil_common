...
class service_provider {
 public:
  void initialize(ros::NodeHandle &nh, id_object_map_ptr id_object_map);
  // TODO: Since there are now smart pointers, just move them to initalize
  // instead of reseting theme
